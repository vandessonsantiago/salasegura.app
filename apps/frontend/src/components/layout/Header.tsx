...
export default function Header({ 
  ...
  return (
    <>
            ...
            <div className="flex space-x-4 items-center">
              ...
              {onResetChat && (
                <>
                  ...
                  <Link
                    href="/login"
                    className="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-md transition-colors text-sm font-medium"
                  >
                    Entrar
                  </Link>
                </>
      ...
      {/* Modal para conversas salvas (apenas na landing) */}
      {onResetChat && (
        <MessageModal
          isOpen={isModalOpen}
